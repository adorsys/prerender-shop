...
app.use(require('prerender-node').set('prerenderServiceUrl', prerenderServiceUrl));
...
console.log('angular app running on http://YOUR_DOCKER_IP:' + PORT + ' using prerender service on ' + prerenderServiceUrl);